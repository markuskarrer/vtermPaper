...
axes[1][1] = processing_Jussis_aggregate_model_plots4paper_aggvDfits.read_and_plot([axes[1][1]],hydro_model ="vterm_bohm",forw_mod=False)[0]
...
'''
xlabels = [r'$D_{max}$ [m]', 'x2',r'$D_{max}$ [m]', '']
ylabels = [r'm [kg]', 'y2',r'm [kg]', '']
